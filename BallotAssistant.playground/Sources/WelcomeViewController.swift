...
public final class WelcomeViewController: UIViewController, UITextViewDelegate {
  ...
  public override func loadView() {
    ...
    bodyText.attributedText = NSAttributedString(string: "Let's get your political preferences set up,\nthen we can provide you with your ballot.\n\nThis will just take a minute.")
  ...
  @objc func nextPage(_ sender: UIButton) {
    let nextViewController = OnboardingSpectrumViewController()
